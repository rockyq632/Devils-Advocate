...
func animate():
	...
	if(play_until_finished): # If locked in an animation
		...
		$AP_Animations.play("POLE_SPIN_KICK")
		...
		$AP_Animations.play("POLE_INVERSION_STRIKE")
		play_until_finished = true
		atk2_ready = false
		atk2_triggered = true
		...
		$AP_Animations.speed_scale = 1
		$AP_Animations.play("POLE_INVERSION_DIVE")
		play_until_finished = true
		atk3_ready = false
		atk3_triggered = true
		...
		$AP_Animations.speed_scale = 1
		$AP_Animations.play("POLE_PIROUETTE")
		play_until_finished = true
		defense_ready = false
...
func _on_attack_body_entered(body: Node2D) -> void:
	#print($A2D_AttackShape/CP_AttackCollision.disabled)
	#print($A2D_AttackShape/CP_Attack2Collision.disabled)
	#print($A2D_AttackShape/CP_Attack3Collision.disabled)
